...
function FrameCaption({ fr, lines, cameraText }: { fr: FrameSettings; lines: FrameLines; cameraText: string | undefined }) {
  ...
  const fontFamily = useFrameFontFamily()
  return (
    <div style={{ fontFamily }} className={`flex items-center gap-2 ${fr.style === 'film' ? '' : 'px-3 py-2'} ${fr.style === 'film' ? 'justify-center' : 'justify-start'}`}>
...
function StrapCaption({ fr, parts, cameraText }: { fr: FrameSettings; parts: StrapParts; cameraText: string | undefined }) {
  ...
  const fontFamily = useFrameFontFamily()
  return (
    <div style={{ fontFamily }} className="flex items-center justify-between gap-3 px-3 py-2">
