      ...
      {order.map((id) => {
        ...
        return (
          <button
            ...
            className={`relative h-[calc(100%-12px)] shrink-0 overflow-hidden rounded-[3px] border bg-bg-0 ${sel ? 'border-accent' : selection.includes(id) ? 'border-accent/50' : 'border-line hover:border-line-strong'}`}
